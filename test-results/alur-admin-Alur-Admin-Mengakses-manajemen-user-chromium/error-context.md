...
- Name: alur-admin.spec.ts >> Alur Admin >> Mengakses manajemen user
- Location: tests\alur-admin.spec.ts:19:7
...
Expected pattern: /.*admin\/manajemen-user/
Received string:  "http://localhost:3000/login?callbackUrl=http%3A%2F%2Flocalhost%3A3000%2Fadmin%2Fmanajemen-user"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    9 × unexpected value "http://localhost:3000/login?callbackUrl=http%3A%2F%2Flocalhost%3A3000%2Fadmin%2Fmanajemen-user"
