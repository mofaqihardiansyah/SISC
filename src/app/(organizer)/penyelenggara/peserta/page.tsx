  ...
  if (!user?.isApproved) {
    return (
      <BlockedOrganizerState 
        title="Data Peserta Terkunci" 
        description="Anda belum dapat mengakses atau mengelola data peserta karena akun penyelenggara Anda saat ini sedang dalam antrean persetujuan verifikasi Admin. Silakan lengkapi profil dan unggah dokumen legalitas Anda." 
      />
    );
  }
