...
export const tagPemberitahuanEnum = pgEnum('tag_pemberitahuan', ['Penting', 'Info']);

export const pemberitahuan = pgTable('pemberitahuan', {
  id: serial('id').primaryKey(),
  tag: tagPemberitahuanEnum('tag').notNull(),
...
export const statusEventEnum = pgEnum('status_event', ['pending', 'published', 'rejected', 'Aktif']);
